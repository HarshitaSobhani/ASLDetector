...
See [`results/comparison.md`](results/comparison.md) and [`results/comparison_chart.png`](results/comparison_chart.png) for the full table/chart (generated by `results/evaluate.py`, filled in after training completes — remember these numbers are on the synthetic placeholder dataset, see caveat above).
